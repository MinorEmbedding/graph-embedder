...
names = ['0.0', '0.11', '0.22', '0.33', '0.44', '0.56', '0.67', '0.78', '0.89', '1.0']
embedded = []
average_generations = []
...
for name in names:
    ...
    filename = f'./data/extend_to_free_prob_50_runs/how_many_generations_5x5_50_600_max_gen_k8_extend_to_free_prob_{name}.txt'
